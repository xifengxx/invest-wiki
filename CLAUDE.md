...
> 分「🔴 薄（8 家，字段都没填齐）」与「⚠️ 中等（32 家，只需展开叙事）」两档。
...
- 深度覆盖公司全部添加 `data_freshness_date` 字段（Phase 3完成时78家 → 2026-09-14 骨架补全/D1-D6批次后 **203家**）
- ⚠️ 保鲜监控覆盖范围为这 203 家；其余 **202 家**公司无 `data_freshness_date`，不纳入扫描
