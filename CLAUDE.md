...
> **当前状态**：496 实体 / 470 图谱节点 / 18 论点 / 0 unknown / 全部验证通过（2026-07-24）
...
| 产业 | 2 |
| 赛道 | 74 |
| 公司 | 392（78家完整数据[Tier1:51 + Tier2:26 + 财报季新增:1]，312家骨架，2家中等） |
| 概念卡片 | 10 |
| 投资论点 | 18 |
| 总词条 | 496 |
| QA 版本 | v1.3 |
...
- **公司详情页**: 覆盖401家公司，8个模块 — Header(名称/代码/国家/角色/层级) → 公司介绍(定位+核心业务+盈利模式) → 详细信息(YAML概览网格+Body 4段深度资料) → 产业链定位 → 上下游关系图谱+供应链关系链 → 竞争格局对比 → 关联赛道 → 关联论点
