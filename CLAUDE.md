...
| 产业 | 2 |
| 赛道 | 81 |
| 公司 | 385（84家完整数据，301家骨架；完整数据 = 含 `data_freshness_date` 字段，Tier1 51 + Tier2 26 + 后续新增 7） |
| 概念卡片 | 10 |
| 投资论点 | 18 |
...
- 84 家深度覆盖公司全部添加 `data_freshness_date` 字段（Phase 3完成时78家，后续新增6家）
- ⚠️ 保鲜监控覆盖范围仅为这 84 家；其余 301 家骨架公司无 `data_freshness_date`，不纳入扫描
