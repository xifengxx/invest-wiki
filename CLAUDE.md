...
| 公司 | 406（2026-09-13：先去重 12 个重复条目 385→373，补建 24 家缺页标的 →397，再补建 9 家赛道成员 →406） |
| 概念卡片 | 10 |
| 投资论点 | 18 |
| 总词条 | 503（2产业 + 67赛道 + 406公司 + 10概念 + 18论点） |
| QA 版本 | v1.3 |
...
> 分「🔴 薄（38 家，字段都没填齐）」与「⚠️ 中等（32 家，只需展开叙事）」两档。
...
- 深度覆盖公司全部添加 `data_freshness_date` 字段（Phase 3完成时78家 → 2026-09-13 骨架补全批次后 **144家**）
- ⚠️ 保鲜监控覆盖范围为这 144 家；其余 **241 家**骨架公司无 `data_freshness_date`，不纳入扫描
