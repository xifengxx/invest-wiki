...
|------|:--:|
| 产业 | 2 |
| 赛道 | 65（唯一数；2026-09-13 合并 16 组跨产业重复档案后由 81 降为 65） |
| 公司 | 385（144家完整数据，241家骨架；完整数据 = 含 `data_freshness_date` 字段。含2026-09-13骨架补全批次新增60家） |
| 概念卡片 | 10 |
| 投资论点 | 18 |
| 总词条 | 480（2产业 + 65赛道 + 385公司 + 10概念 + 18论点） |
| QA 版本 | v1.3 |
