...
> 分「🔴 薄（28 家，字段都没填齐）」与「⚠️ 中等（32 家，只需展开叙事）」两档。
...
- 深度覆盖公司全部添加 `data_freshness_date` 字段（Phase 3完成时78家 → 2026-09-13 骨架补全/D1/D2批次后 **153家**）
- ⚠️ 保鲜监控覆盖范围为这 153 家；其余 **252 家**公司无 `data_freshness_date`，不纳入扫描
