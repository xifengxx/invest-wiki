...
chain_role: 核心参与者
suppliers:
- company: ASML/东京电子/Applied Materials
  supplies: 晶圆制造设备
  note: 12寸DRAM厂设备需求
- company: 硅片供应商（SUMCO/环球晶圆等）
  supplies: 300mm硅晶圆
  note: 12寸厂消耗
customers:
- company: AI服务器/数据中心客户
  revenue_pct: 20
  note: AI基础设施DDR5/定制DRAM，目标2027年30%
- company: SanDisk/Cisco/Kioxia/Solidigm
  revenue_pct: 50
  note: 4家LTA战略投资者锁定约50%产出
- company: 消费电子/工业/汽车
  revenue_pct: 30
  note: DDR4/LPDDR4/LPDDR5标准DRAM
partners:
- company: SanDisk/Cisco/Kioxia/Solidigm
  area: 长期供应协议（LTA）+战略持股
  note: 2026.4私募NT$787亿入股10.19%，LTA覆盖~50%产出
- company: 台积电
  ticker: TSM
  area: WoW/3D IC定制DRAM
  note: DRAM直接堆叠在CPU/ASIC上，带宽5-10x
competitors:
- company: 三星/SK海力士/美光（三巨头）
  ticker: MU
  area: DRAM
  note: 主导DDR5/HBM，主动退出DDR4/DDR3
- company: 华邦电子（Winbond）
  area: 利基DRAM
  note: 台湾利基DRAM同业竞争
core_business:
- 利基DRAM制造（DDR4/DDR3/LPDDR4/LPDDR3，全球#6，三大巨头退出留下的供应缺口）
- DDR5 DRAM（1C/1D/1E 10nm级制程推进中，目前~10%营收，H2 2026 LPDDR5客户认证）
- 定制AI DRAM（高I/O DRAM，WoW晶圆堆叠+3D IC，带宽5-10x/能效10x，2027年起量）
- 新12寸5A厂建设（2028年Phase 1量产30K/月，总产能45K/月，总CAPEX $16B）
revenue_model: H1 2026营收NT$1,316亿（+643% YoY），Q2 NT$825.5亿（+68% QoQ / +684% YoY），毛利率79.5%（Q2），净利率60.8%，EPS H1 NT$23.38。DRAM ASP Q2 +60% QoQ，毛利率超越台积电（~66%）。4家战略投资者私募NT$787亿（2026.4），LTA锁定~50%产出，极大降低周期波动。分析师预测2027 EPS NT$127+（12.7个股本），目标价NT$548-750。5A新厂$16B CAPEX，产量+120%（2028-2030）。
founded: 1995
...
全球利基DRAM隐形冠军，三大巨头退出DDR4/DDR3造成供应缺口，毛利率79.5%超越台积电，4家战略投资者LTA锁定50%产出，定制AI DRAM（WoW+3D IC）2027年起量。

## 财务状况

| 指标 | Q1 2026 | Q2 2026 | H1 2026 |
|------|---------|---------|---------|
| **营收** | NT$490.9亿 | **NT$825.5亿** | **NT$1,316亿** |
| **毛利率** | 67.9% | **79.5%** | — |
| **净利率** | 53.1% | 60.8% | — |
...
| 维度 | 三星/SK/美光 | 南亚科技 |
|------|:--:|:--:|
| **DDR5/HBM** | 全力扩产（高ASP/高利润） | 少量（~10%营收，逐步爬坡） |
| **DDR4/DDR3** | 加速退出（产能转移） | **全力扩产**（填补供应缺口） |
| **DRAM ASP趋势** | HBM/DDR5涨价 | DDR4/DDR3涨价更猛（供应更紧） |
| **毛利率** | ~55-85% | **79.5%**（逼近美光84.9%） |
...
- **LTA锁定50%产出**：SanDisk/Cisco/Kioxia/Solidigm入股10.19%，减少周期波动
