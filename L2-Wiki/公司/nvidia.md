...
- 自动驾驶
- 边缘AI
one_liner: 全球领先的AI全栈基础设施公司，核心为AI训练/推理GPU与数据中心系统（Blackwell、Rubin、DGX），通过GPU芯片与系统级解决方案销售实现盈利（数据中心收入占约90%），位于AI计算基础设施核心供应商——掌握约80%市场份额与CUDA生态壁垒的AI算力平台。
chain_layer: L3
chain_role: 龙头
suppliers:
- company: SK海力士
...
employees: ~36,000
latest_revenue: FY2026 $215.9B（TTM $253.5B）
