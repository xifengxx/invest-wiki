...
chain_role: 龙头
suppliers:
- company: 高纯碳化硅粉末/石墨供应商
  supplies: SiC晶体生长所需原料
customers:
- company: 汽车OEM/Tier1（通用/捷豹路虎/奔驰等）
  revenue_pct: 40
  note: SiC MOSFET牵引逆变器/车载充电
- company: 能源/工业客户
  revenue_pct: 30
  note: 光伏逆变器/储能/工业电源SiC器件
- company: AI数据中心电源客户
  revenue_pct: 10
  note: 高效AI服务器电源SiC方案（3.3kV功率模块）
partners:
- company: 通用汽车/捷豹路虎
  area: 汽车SiC器件长期供应
  note: 多年代设计中标绑定
...
- company: Rohm
  ...
  note: 日本SiC龙头
core_business:
- SiC衬底制造（200mm全球最大产能Mohawk Valley Fab，~33%营收）
- SiC功率器件（MOSFET/肖特基二极管/功率模块，~67%营收）
- 下一代3.3kV SiC功率模块（AI数据中心电源+电网应用）
revenue_model: TTM营收~$730M（-6-8%），净亏损持续（季度亏损~$150M，TTM亏损~$500M+），负毛利率。总债务~$922M。SiC长期TAM CAGR 30%+但产能爬坡缓慢+需求低谷拖累短期财务。YTD股价+274%（AI/EV SiC需求预期修复）。
founded: 1987
