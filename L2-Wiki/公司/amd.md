...
- GPU制造代工
- GPU架构设计
one_liner: 全球第二大x86处理器与AI GPU芯片设计公司，核心为数据中心CPU/GPU（EPYC Turin、Instinct MI350/MI450）、客户端PC芯片（Ryzen）及FPGA（Xilinx），通过无晶圆厂芯片设计与系统平台销售实现盈利，位于AI计算第二梯队挑战者——以开放生态（ROCm）和性价比重构AI基础设施竞争格局。
chain_layer: L3
chain_role: 龙头
suppliers:
- company: 台积电
...
| 营收 | ~$227亿 | $258亿 | **$346亿** |
| 毛利率(GAAP) | ~50% | 49% | **50%** |
| 净利润(GAAP) | ~$8.5亿 | $16.3亿 | **$43亿** |
| 数据中心收入 | ~$65亿 | ~$126亿 | **$166亿** |
