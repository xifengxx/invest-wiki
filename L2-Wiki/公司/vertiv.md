...
chain_role: 龙头
suppliers:
- company: 电力电子/冷却部件供应商
  supplies: 功率半导体/压缩机/换热器
customers:
- company: NVIDIA
  ticker: NVDA
  revenue_pct: 10
  note: Vera Rubin DSX AI工厂核心冷却+电源伙伴
- company: 超大规模云服务商（Microsoft/Google/Amazon等）
  note: 数据中心UPS/配电/液冷全线
partners:
- company: NVIDIA
  ticker: NVDA
  area: AI数据中心液冷+数字孪生
  note: Vera Rubin DSX平台核心合作
competitors:
- company: Eaton
  ticker: ETN
  area: 数据中心电源/热管理
  note: 收购Boyd Thermal后竞争加剧
...
- company: Delta Electronics
  ...
  note: 电源效率全球领先
core_business:
- 数据中心UPS与配电系统（AI数据中心不间断电源/开关柜/母线槽）
- 液冷散热解决方案（直接芯片液冷/浸没式/冷板，收购Strategic Thermal Labs+ThermoKey）
- IT基础设施管理（机架PDU/监控/数字孪生）
revenue_model: Q1 2026 $2.65B（+30%），FY2026E $13.5-14B（上调15%），Adj EPS $6.30-6.40。积压>$15B（+252%订单暴增）。P/E ~50x Forward。收购补强液冷全线。
